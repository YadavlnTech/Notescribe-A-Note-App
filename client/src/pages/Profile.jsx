...
//                         </h2>
//                         <p className="mt-1 text-center">john@123</p>
//                         <p className="mt-1 text-center">
//                             hckjdshhd fbwvjbwfvb jfbwijfb
//                         </p>
//                     </div>
//                 </div>
//                 {/* counts */}
...
//                             <div
//                                 key={i}
//                                 className="flex w items-center justify-between rounded-lg border border-black px-4 py-2 text-black"
//                             >
//                                 <p className="">
//                                     sem8
//                                 </p>
