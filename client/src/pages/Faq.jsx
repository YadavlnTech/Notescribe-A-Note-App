...
const Faq = () => {
    const faqs = [
        {
            question: "What is Notescribe?",
            answer:
                "Notescribe is an online platform designed to facilitate the sharing and access of educational resources among college students. It allows users to upload and download study materials such as notes, presentations, and study guides.",
        },
        {
            question: "How do I get started with Notescribe?",
            answer:
        ...
        {
            question: "Is Notescribe free to use?",
            answer:
                "Yes, Notescribe is free to use. We believe in making education accessible to everyone, and our platform is open to all students without any subscription fees.",
        },
        {
            question: "Are my documents secure on Notescribe?",
            answer:
        ...
        {
            question: "Can I upload any type of document on Notescribe?",
            answer:
        ...
        {
            question: "How can I search for specific study materials on Notescribe?",
            answer:
        ...
        {
            question:
                "Can I collaborate with other students on projects using Notescribe?",
            answer:
                "Absolutely. Notescribe offers real-time collaboration tools, allowing you to work on group projects and assignments with your peers. Share, edit, and collaborate seamlessly.",
        },
        {
        ...
        },
        {
            ...
            answer:
                "Each document on Notescribe comes with a feedback and rating section. You can share your thoughts, ask questions, or provide feedback on the quality of the material.",
        },
    ];
    return (
