            ...
            <div className="flex h-full  w-full flex-col items-center justify-center">
                <div className="">
                    ...
                    <p className="mt-1 text-[15px] lg:mt-3">
                        Welcome to Notescribe, the ultimate hub for students to seamlessly
                ...
                <div className="">
                    ...
                    <p className="mt-1 text-[15px] lg:mt-3">
                        Notescribe is more than just a website; it's a community-driven
                ...
                <div className="">
                    ...
                    <p className="mt-1 text-[15px] lg:mt-3">
                        At Notescribe, our mission is clear: to empower students by
