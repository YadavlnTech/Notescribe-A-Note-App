...
//             <div className="absolute inset-0 bg-black bg-opacity-70" />
//             <div className="relative z-10 w-full max-w-[860px] text-center text-white">
//                 <h1 className="text-4xl font-black md:text-5xl">MemoSearch</h1>
//                 <p className="mt-5 text-sm font-light md:text-xl md:font-normal">
//                     Welcome to MemoSearch – where students unite for effortless
//                     organization, access, and sharing of PDF notes. Say goodbye to
//                     scattered notebooks; streamline your study routine and embark on a
//                     journey to academic excellence. Simplify your student life, make your
//                     notes work for you – discover a new era of innovation, start today
...
const Hero = () => {
    ...
    return (
        <div className="bg-unsplashBgImage relative flex h-full items-center justify-center bg-cover bg-center">
            <div className="absolute inset-0 bg-black bg-opacity-70" />
            <div className="relative z-10 w-full max-w-[860px] text-center text-white">
                <h1 className="text-4xl font-black md:text-5xl">Notescribe</h1>
                <p className="mt-5 text-sm font-light md:text-xl md:font-normal">
                    Welcome to NoteScribe – the ultimate destination for students to effortlessly organize, access, and share PDF notes. Say goodbye to scattered notebooks and streamline your study routine. Embark on a journey to academic excellence with NoteScribe. Simplify your student life and make your notes work for you. Discover a new era of innovation and start today!
                </p>
                <div className="mt-5">
                    {/* <Link to="/search">
            <button className="rounded-xl bg-white px-7 py-4 font-black text-blue-500 ">
